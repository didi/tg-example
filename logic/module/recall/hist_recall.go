...
type HistRecall struct {
	wfengine.ModelBase
}

func (h HistRecall) DoAction(ctx context.Context, sc *model.StrategyContext) interface{} {
	...
	items := mock.MockHistRecall(2)
	sc.Set(constants.CONTEXTKEY_HIST_RECALL_INFO, items)
